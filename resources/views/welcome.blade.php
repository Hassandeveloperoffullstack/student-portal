            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="" class="nav-item nav-link">
                    @if (Route::has('login'))
                        ...
                        <a href="{{ url('/admin/dashboard') }}" class="nav-item nav-link  text-primary">
                            Dashboard
                        </a>
                        @else
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="row g-2 pt-2">
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="{{ asset('images/course-1.jpg') }}"
                                alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="{{ asset('images/course-2.jpg') }}"
                                alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="{{ asset('images/course-3.jpg') }}"
                                alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="{{ asset('images/course-2.jpg') }}"
