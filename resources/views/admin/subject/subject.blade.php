                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$subjects->name}}</td>
                                        <td>
                                            <a href="{{route('subject.edit',$subjects->id)}}" class="btn btn-warning text-white rounded-0" >Update</a>
                                            <a href="{{url('admin/subject/delete',$subjects->id)}}" class="btn btn-danger rounded-0">Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
