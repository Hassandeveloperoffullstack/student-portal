        ...
        <main class="content px-3 py-2">
            <div class="container-fluid">
                ...
                <div class="card border-2 mt-4">
                    ...
                    <div class="card-body">
                        {!! html()->form('POST', route('department.submit'))->open() !!}
                        {{ csrf_field() }}
                        <div class="form-group py-2">
                            {!! html()->label('Department')->for('name')->class('form-label') !!}
                            {!! html()->text('name')->class('form-control')->placeholder('Enter Department') !!}
                            @error('name')
