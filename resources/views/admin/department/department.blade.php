                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('department.edit',$departments->id)}}" class="btn btn-warning text-white rounded-0" >Update</a>
                                            <a href="{{route('department.delete',$departments->id)}}" class="btn btn-danger rounded-0">Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
