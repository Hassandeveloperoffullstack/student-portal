                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$sessions->name}}</td>
                                        <td>
                                            <a href="{{route('session.edit',$sessions->id)}}" class="btn btn-warning text-white rounded-0" >Update</a>
                                            <a href="{{route('session.delete',$sessions->id)}}" class="btn btn-danger rounded-0">Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
